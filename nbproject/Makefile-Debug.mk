...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tplstate.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tplstate ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/_ext/552806006/SWMachine.o: /C/prog/c++/tplstate/SWMachine.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/552806006
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/552806006/SWMachine.o /C/prog/c++/tplstate/SWMachine.cpp
...
${OBJECTDIR}/_ext/552806006/TS.o: /C/prog/c++/tplstate/TS.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/552806006
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/552806006/TS.o /C/prog/c++/tplstate/TS.cpp

${OBJECTDIR}/_ext/552806006/SWMachineB.o: /C/prog/c++/tplstate/SWMachineB.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/552806006
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/552806006/SWMachineB.o /C/prog/c++/tplstate/SWMachineB.cpp

${OBJECTDIR}/_ext/552806006/PTest.o: /C/prog/c++/tplstate/PTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/552806006
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/552806006/PTest.o /C/prog/c++/tplstate/PTest.cpp

${OBJECTDIR}/_ext/552806006/TSB.o: /C/prog/c++/tplstate/TSB.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/552806006
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/552806006/TSB.o /C/prog/c++/tplstate/TSB.cpp
