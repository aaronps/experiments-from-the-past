...
${OBJECTDIR}/src/TrackinDevice.o: src/TrackinDevice.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I../slog/include -I../ccollections/include -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TrackinDevice.o src/TrackinDevice.c

${OBJECTDIR}/src/collections/SList.o: src/collections/SList.c 
	${MKDIR} -p ${OBJECTDIR}/src/collections
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I../slog/include -I../ccollections/include -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/collections/SList.o src/collections/SList.c

${OBJECTDIR}/src/rtracker.o: src/rtracker.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I../slog/include -I../ccollections/include -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/rtracker.o src/rtracker.c
